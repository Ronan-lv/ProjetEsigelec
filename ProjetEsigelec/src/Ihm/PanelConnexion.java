...
/**
 * Classe qui permet l'affichage de la page de connexion
 * 
...
public class PanelConnexion extends PanelGenerique implements ActionListener {
	...
	/**
	 * Constructeur de la Classe PanelConnexion
	 * 
	 * @param fen
	 */
	public PanelConnexion(Fenetre fen) {
		...
		this.setLayout(new GridLayout(5, 0, 0, 20)); // Les 2 dernières valeurs correspondent respectivement à
														// l'espacement entre les lignes et les colonnes

		this.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(120, 200, 120, 200), // Empty
																												// border
																												// =>
																												// top,
																												// left,
																												// bottom,
																												// right
				BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(Color.BLACK, 3, true),
	...
	/**
	 * Méthode qui permet de gérer les évenement d'un utilisateur sur ce panel ,
	 * souris ,clavier ...
	 * 
