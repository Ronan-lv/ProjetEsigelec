...
/**
 * Classe qui permet l'affichages des fichiers référencés
 * 
...
public class PanelFichiersReferences extends PanelGenerique implements ActionListener {
	...
	/**
	 * Constructzeur de la Classe PanelFichierRéferences
	 * 
	 * @param fen
	 */
	...
	/**
	 * Méthode qui permet le remplissage du panelMilieu avec des lignes graphiques
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.boutonSupprimer) {
			...
			if (JOptionPane.showConfirmDialog(this, "Êtes-vous sûr de vouloir supprimer le projet ?", "Suppresion",
